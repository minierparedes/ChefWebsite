...
export default function RecipeDetails() {
    ...
    return (
        <div>
            ...
            {selectedRecipe && <div className="main-container">
                <div className="hero-section" ><HeroSection src={convertBufferToBase64(selectedRecipe.img.data)} title={selectedRecipe.title}/></div>
                ...
                <div className="sidebar">{selectedRecipe.ingredients}</div>
